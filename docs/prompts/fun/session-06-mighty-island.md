...
- Session ID: `ses_2f24f87eeffeBIj85L8TWE9enr`
- Slug: `mighty-island`
- Directory: `/home/fun/proj/funnovation2026`
- Created: 2026-03-20 23:59:22 UTC
- Updated: 2026-03-21 00:08:25 UTC
- Prompt count: 7
...
### 003 - 2026-03-20 22:56:35 UTC

```text
yes do that, save the prompts
```

### 004 - 2026-03-20 23:08:35 UTC
...
### 005 - 2026-03-20 23:57:57 UTC

```text
I will go with 1, will have function calling, however there's no place to wire it to right now, that's blocked by the rest of the team. Write the prompt to ai/prompts/ and some notes about implementation for future code reviewers / implementers at ai/docs/LIVE.md
```

### 006 - 2026-03-21 00:01:38 UTC

```text
let's add similar documentation for the general application of other prompts as well - it's required by the rules
```

### 007 - 2026-03-21 00:07:36 UTC

```text
yes write the consolidated documentation with an birds eye overview of prompting techniques, how we ensure safety and use schemas for structured output
```
